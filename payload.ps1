...
if ($type -eq "single_enc") { DoSingleFileENC }
if ($type -eq "multi_ren") { DoMultipleFilesREN }
if ($type -eq "single_ren") { DoSingleFileREN }
if ($show_screen.ToUpper() -eq "YES" -Or $show_screen.ToUpper() -eq "TRUE") { DoShowScreen }
